...
class Gsender
{
   ...
   private:
       ...
       const char* EMAILBASE64_LOGIN      = "xxxxxxxxxxxxxxxxxxxxxxxx";     // 64 bit encoded email address name
       const char* EMAILBASE64_PASSWORD   = "xxxxxxxxxxxx";                 // 64 bit encoded email password
       const char* FROM                   = "xxxxxxxxxxxxx";                // email
